...
const SHORTCUTS: Array<{ keys: string; action: string; touch: string }> = [
  ...
  { keys: 'F5 F6 F7', action: 'Elegir Yape, Tarjeta o Fiado como método de pago', touch: 'Botones de método' },
  { keys: 'F8', action: 'Consulta de precio sin tocar el ticket', touch: '— (escanea y cancela)' },
  { keys: 'F9 / Supr', action: 'Quitar la línea seleccionada del ticket', touch: 'Botón ✕ de la línea' },
  { keys: '—', action: 'Descuento: botón % en la línea o «% Descuento a la venta»', touch: 'Toca la línea → panel de acciones' },
